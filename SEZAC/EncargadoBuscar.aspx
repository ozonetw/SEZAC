...
<asp:Content ContentPlaceHolderID="ContentPlaceHolderR" ID="oversoul" runat="server">
	<div>
		<p>
			Introduzca los términos de busqueda.
            <br />
			<br />
		</p>
	</div>
	<div class="row">
		...
		<div class="col-md-2">
			<asp:Button ID="btnBuscar" runat="server" CssClass="btn btn-primary btn-lg" Text="BUscar" OnClick="btnBuscar_Click" />
		</div>
	</div>
	<div class="col-lg-10">
			...
			<div class="form-horizontal">
				<fieldset>
					...
					<div class="form-group">
						<div>
							<asp:GridView ID="usrGrid" runat="server"  EmptyDataText="No hay registros que coincidan con los parámetros de búsqueda suministrados" />
						</div>
					</div>
				</fieldset>
			</div>
