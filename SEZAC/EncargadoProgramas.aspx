...
<asp:Content ContentPlaceHolderID="ContentPlaceHolderR" ID="enProg" runat="server">
	...
	<div class="form-group">
		...
		<input class="form-control" runat="server" id="inputPrograma" type="text" value="Por favor, ingrese el nombre de el programa a crear." onfocus="javascript:borrar(this);" />
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label class="control-label" for="focusedInput">Año Fiscal:</label>
	...
	<div>
		<asp:Button ID="btnConfirmar" runat="server" CssClass="btn btn-default" Text="Confirmar" OnClick="btnConfirmar_Click" />
	</div>
	<div>
		<br />
